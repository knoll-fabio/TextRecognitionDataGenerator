...
from trdg import computer_text_generator, computer_pictogram_generator, background_generator, distorsion_generator
...
class FakeTextDataGenerator(object):
    ...
    def generate(
        ...
        if is_handwritten:
            ...
            image, mask = computer_pictogram_generator.generate(pictograms_path, pictograms, size, 5)
        else:
